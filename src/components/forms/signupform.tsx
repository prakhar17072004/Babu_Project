  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-100">
      <div className="relative bg-white p-6 rounded-lg shadow-lg w-96 text-center">
        {/* Close Icon (Replaces "Back to Get Started") */}
        ...
        {!role ? (
          ...
          <div>
            ...
            <form className="text-left">
              ...
              <div className="mb-4">
                <label className="block font-semibold">Email or Phone No <span className="text-red-500">*</span></label>
                <input type="email" placeholder="Enter your email" className="w-full p-3 border rounded" required />
              </div>

              <div className="mb-4">
                <label className="block font-semibold">Password <span className="text-red-500">*</span></label>
                <input type="password" placeholder="Enter your password" className="w-full p-3 border rounded" required />
              </div>
              ...
              {role === "babu" && (
                <div className="mb-4">
                  ...
                  <input type="text" placeholder="Enter Babu ID" className="w-full p-3 border rounded" required />
                </div>
              )}
              ...
              {role === "admin" && (
                <div className="mb-4">
                  ...
                  <input type="text" placeholder="Enter Admin Code" className="w-full p-3 border rounded" required />
                </div>
              )}
